...
- Name: 03-git-terminal-code-browser.spec.ts >> Git stage >> commit flow creates a real commit in the fixture repo
- Location: tests\e2e\specs\03-git-terminal-code-browser.spec.ts:92:7
...
Locator: locator('textarea[placeholder="Commit message"]')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('textarea[placeholder="Commit message"]')
