...
- Name: 03-git-terminal-code-browser.spec.ts >> Code stage >> file tree lists fixture files and opening one loads the editor
- Location: tests\e2e\specs\03-git-terminal-code-browser.spec.ts:147:7
...
Locator: getByText('README.md', { exact: true }).first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('README.md', { exact: true }).first()
